...
| Portfolio | Markowitz optimization | Implemented | Minimum-variance and maximum-Sharpe portfolios |
| Asset pricing | CAPM | Implemented | Beta, alpha, and expected return analysis |
| Risk | VaR, CVaR, stress testing | Implemented | Portfolio loss and downside-risk reporting |
