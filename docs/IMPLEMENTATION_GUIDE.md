...
These make the repository useful beyond pricing by connecting models to allocation and downside-risk decisions.
...
1. Accept portfolio value, weights, and asset-level shock returns.
2. Compute stressed portfolio return.
3. Convert the return into stressed value and loss.
4. Compare multiple shock scenarios.
